...
export default function Steps() {
  return (
    <>
      <div className="flex flex-wrap gap-12 justify-center mx-auto max-w-[70rem] pt-[0rem] pb-[6rem] md:pt-[4rem] md:pb-[12rem] items-start cursor-pointer">
        {steps_data.map((item, index) => (
          <div
            key={index}
            className="flex flex-col max-w-[21rem] p-[1rem] gap-[2rem]"
          >
